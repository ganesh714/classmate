...
@router.post("/chats", response_model=ChatInDB, status_code=status.HTTP_201_CREATED)
...
@router.post("/chats/{chat_id}/messages", response_model=ChatInDB)
...
@router.put("/chats/{chat_id}", response_model=ChatInDB)
